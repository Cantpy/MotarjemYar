...
# maximize_icon = qta.icon('fa.window-maximize')
# close_icon = qta.icon('fa.xmark')
# home_icon = qta.icon('fa.home')
# invoice_icon = qta.icon('fa.file-invoice')
# settings_icon = qta.icon('fa.cog')
# user_icon = qta.icon('fa.user')
# logout_icon = qta.icon('fa.right-from-bracket')

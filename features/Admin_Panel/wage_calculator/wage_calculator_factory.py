...
class WageCalculatorFactory:
    ...
    """
    @staticmethod
    def create(session_provider: SessionProvider) -> WageCalculatorController:
        """
        ...
        logic = WageCalculatorLogic(repository=repo, session_provider=session_provider)
...
if __name__ == '__main__':
    ...
    wage_calculator_controller = WageCalculatorFactory.create(
        session_provider=session_provider
    )

    # --- Run the UI ---
    main_widget = wage_calculator_controller.get_view()
    main_widget.show()

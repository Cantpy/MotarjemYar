...
import logging
from features.Invoice_Table_GAS.invoice_table_GAS_assets import INVOICES_DB_URL, USERS_DB_URL
...
class DatabaseRepository:
    ...
    def __init__(self, invoices_db_url: str = INVOICES_DB_URL, users_db_url: str = USERS_DB_URL):
        """Initialize database connections"""
        self.invoices_engine = create_engine(f"sqlite:///{invoices_db_url}")
        self.users_engine = create_engine(f"sqlite:///{users_db_url}")

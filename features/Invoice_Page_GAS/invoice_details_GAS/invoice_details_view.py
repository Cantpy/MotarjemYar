...
from features.Invoice_Page_GAS.invoice_details_GAS.invoice_details_models import InvoiceDetails, Language
...
class InvoiceDetailsWidget(QWidget):
    ...
    def _init_widgets(self):
        ...
        self.delivery_date_edit = DatePickerLineEdit()
    ...
    def _setup_ui(self):
        ...
        # Apply styling
        from features.Invoice_Page_GAS.invoice_details_GAS.invoice_details_qss import INVOICE_DETAILS_QSS

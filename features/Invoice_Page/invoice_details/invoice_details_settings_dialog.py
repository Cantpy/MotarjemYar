...
class SettingsManager:
    ...
    def load(self):
        ...
        try:
            # Check if the file is empty, which also causes a JSONDecodeError
            ...
            # --- IMPROVEMENT: Use a deep copy to prevent accidental modification of defaults ---
    ...
    def save(self):
        ...
        os.makedirs(directory, exist_ok=True) # This is still correct and necessary
        with open(self.filepath, 'w', encoding='utf-8') as f:
            json.dump(self.settings, f, indent=4, ensure_ascii=False)

    def get(self, key, default=None):
        """Gets a setting value by key."""
        # Use deepcopy to prevent external mutation of internal dicts
